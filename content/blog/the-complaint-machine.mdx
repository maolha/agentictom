...
date: "2026-05-15"
theme: "demand-side"
excerpt: "Clients rarely complain because the effort exceeds the payoff. AI agents remove the friction: every suitability gap surfaced as a structured complaint."
standfirst: "Clients rarely complain because the effort exceeds the payoff. AI agents remove the friction: every suitability gap and every underperforming mandate surfaced automatically, as structured, evidenced complaints. Institutions that audit their own book first will meet them prepared."
---
...
Every head of compliance knows this and rarely says it aloud: **the current volume of client complaints measures client effort, not client satisfaction.**

Most clients do not complain, and satisfaction has little to do with it. Identifying what went wrong, gathering evidence, articulating the issue, and pursuing it through the bank's process costs more energy than the likely outcome justifies.
...
**The complaints will be analytical rather than emotional.** That is a conversation the relationship manager has not been trained for.
...
The complaint machine is a specific instance of something broader: **AI agents will enforce suitability standards, fee disclosure obligations, and risk documentation requirements that the industry relied on clients not to enforce**. The standards existed. The cost of enforcing them was borne by the client.
...
The technology exists today. The banks that assume they have time are making the same bet they made about digital banking a decade ago.

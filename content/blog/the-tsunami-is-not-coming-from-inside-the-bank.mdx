...
| Stage | Today | Agent world | Multiplier |
|---|---|---|---|
| Mortgage inquiries per seeker | 3-5 | 30+ per property, multiple properties | 10-30× |
| Formal applications per transaction | 4-6 | 40-60+ | ~10× |
| Properties purchased | ~50'000 | ~50'000 | 1× |

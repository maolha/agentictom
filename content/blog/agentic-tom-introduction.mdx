...
They ask where they can use AI. The better question is what the organisation looks like when AI is a participant, not just a tool.
...
IBM surveyed 800 executives and found that 78 percent believe capturing full value from agentic AI requires a new operating model where humans and systems learn together. McKinsey estimates that current AI technologies could automate roughly 57 percent of work hours in banking. BCG projects that AI could increase bank profitability by 30 percent and reduce costs by 30 to 40 percent by 2030.

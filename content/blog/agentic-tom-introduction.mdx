...
date: "2026-01-08"
theme: "the-model"
excerpt: "Most AI discussions in banking pick tools. The consequential question is how the organisation itself must change to absorb what the tools make possible."
standfirst: "Most AI discussions in banking pick tools. The consequential question is how the organisation itself must change: three layers of workforce, escalation designed in, and outcomes owned end-to-end."
---
...
The subject is agents, not automation. Automation executes predefined rules on predefined inputs. A bot that reconciles 50'000 transactions per day is executing instructions.
...
**For a CEO**, the agentic TOM is a strategic question: what is the target state, and how fast is the institution moving toward it? DBS Bank completed nine operating model transformation initiatives in 2025 and has reskilled more than 11'000 employees whose roles AI is reshaping. That is the pace of a bank that has decided to move. Most Swiss banks have not.
...
Klarna offers the most instructive lesson. In 2024, the company deployed an AI assistant that it said replaced the work of 700 human agents. Resolution time dropped from 11 minutes to under 2. The company projected a profit improvement of USD 40 million for 2024.

**Within a year, they reversed course.** Quality slipped on complex cases. In May 2025 the CEO said the automation push had gone too far, and Klarna began recruiting humans again so that a customer can always reach a person.
...
**The technology is ready.** According to Evident Insights, agentic AI deployments at the top 50 global banks grew 13 times in a single year (2024-2025). The gap between experimentation and operating model redesign is where most banks are stuck.
...
This post defines the concept. The essays that followed explore its implications, organised in four threads on the [Thoughts page](/blog). Six to start with:
...
The [framework page](/framework) visualises the three-layer model. The [assessment](/assessment) shows where your institution stands today.

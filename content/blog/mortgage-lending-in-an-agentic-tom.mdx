...
date: "2026-03-05"
theme: "in-practice"
excerpt: "Mortgage origination redesigned across bots, agents and humans, grounded in what FINMA actually requires. Same rules, different cost structure, different speed."
...
[FINMA Guidance 08/2024](/finma-guidance-08-2024) says something specific about autonomous AI decisions. The regulatory constraint is less restrictive than most Swiss bankers assume, and more specific than they expect.
...
**The trigger is the cost of being wrong exceeding the agent's authorisation level, never mere uncertainty.** Under FINMA 08/2024, the escalation architecture is the mechanism by which the bank fulfils its accountability obligations.
...
Every Swiss bank processes mortgages. The process is broadly similar across institutions. The economics are broadly similar. The regulatory framework, FINMA 08/2024 included, permits the model described here, provided the governance is designed, not assumed.
